...
const PlaceDetailModal = styled.div`
  ...
  transition:height ease-out 1s 2s;
  position: absolute;
  left:350px;
  width: 400px;
  height: 90vh;
...
const PlaceDetailModalHeader = styled.div`
    ...
    >div:nth-child(2){ //좋아요, 북마크
      display: flex;
      >p:nth-child(1){
        font-size: 14px;
        width: 60px;
        height: 20px;
        margin: 15px 240px 0 20px;
        line-height: 20px;
        font-weight: 600;
        color:var(--black-700);
      }
...
const Map = () => {
  ...
  return(
    ...
    <Container>
      ...
      : null}
      { detailModal ? 
        <KakaoMap width="100%" height="90vh" dataList={listData} position="absolute" left="750px"></KakaoMap>: 
        <KakaoMap width="100%" height="90vh" dataList={listData} position="absolute" left="350px"></KakaoMap>
        }
    </Container>
    </>
  )
