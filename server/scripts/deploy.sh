...
BUILD_JAR=$(ls /home/ubuntu/action/build/libs/project-0.0.1-SNAPSHOT.jar)
...
nohup java -jar project-0.0.1-SNAPSHOT.jar --spring.profiles.active=server >> /home/ubuntu/deploy.log 2>/home/ubuntu/action/deploy_err.log &
